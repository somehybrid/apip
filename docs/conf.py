#
# apip documentation build configuration file, created by
...
version = ''
with open('../apip/__init__.py') as f:
...
resource_links = {
  'issues': 'https://github.com/SomeHybrid/apip/issues',
  'discussions': 'https://github.com/SomeHybrid/apip/discussions',
  'examples': f'https://github.com/SomeHybrid/apip/tree/{branch}/examples',
}
...
htmlhelp_basename = 'apipdoc'

man_pages = [
    ('index', 'apip', 'apip Documentation',
     ['SomeHybrid'], 1)
]
...
texinfo_documents = [
  ('index', 'apip', 'apip Documentation',
   'SomeHybrid', 'apip', 'One line description of project.',
   'Miscellaneous'),
]
